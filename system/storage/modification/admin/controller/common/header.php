...
class ControllerCommonHeader extends Controller {
                ...
                public function index() {
                    ...
                    //Get the SEOMatic Settings
                    $settings = $this->model_setting_setting->getSetting( 'seomatic' ) ;

                    //If we have SEOMatic Settings
                    if(!empty( $settings ) && isset( $this->session->data['token'] )){
                
        				//Add Scripts
        				$this->document->addScript( 'view/javascript/seomatic/seomatic.js' );

        				$this->document->addScript( $this->url->link('extension/seomatic/seomatic/javascript' , 'token=' . $this->session->data['token'] ) );
        				$this->document->addScript( 'view/javascript/seomatic/loader.js' );

                        //AMChart Scripts
                        $this->document->addScript( 'view/javascript/seomatic/amcharts/amcharts.js' );
                        $this->document->addScript( 'view/javascript/seomatic/amcharts/funnel.js' );
                        $this->document->addScript( 'view/javascript/seomatic/amcharts/gauge.js' );
                        $this->document->addScript( 'view/javascript/seomatic/amcharts/pie.js' );
                        $this->document->addScript( 'view/javascript/seomatic/amcharts/radar.js' );
                        $this->document->addScript( 'view/javascript/seomatic/amcharts/serial.js' );
                        $this->document->addScript( 'view/javascript/seomatic/amcharts/xy.js' );
                        $this->document->addScript( 'view/javascript/seomatic/amcharts/themes/light.js' );

        				//Add Style
        				$this->document->addStyle( 'view/stylesheet/seomatic.css' );
