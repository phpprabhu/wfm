		...
		<div class="col-md-9 col-sm-9 col-sms-12">
            ...
            <?php if ($recurrings) { ?>
				...
				<div class="form-group">
				  ...
				  <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block"><span class="sp-button" ><?php echo $button_cart; ?></span></button>
				</div>
				<?php if ($minimum > 1) { ?>
