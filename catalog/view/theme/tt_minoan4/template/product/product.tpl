		...
		<div class="col-md-9 col-sm-9 col-sms-12">
			...
			<div class="<?php echo $class; ?>">
			  ...
			  <div class="price">
				...
				<?php echo $price; ?>
				<?php } else { ?>
				  <span class="price-text-style price-padding">List Price: </span><span style="text-decoration: line-through;"><?php echo $price; ?></span>
				  <div><span class="price-text-style discount-price-padding">Discounted Price: </span><span class="price-orange"><?php echo $special; ?></span><img src="image/catalog/free_shipping.png" style="padding-left:40px;"></div>
				  <div><span class="price-text-style save-price-padding">You save: </span><span class="price-orange"><?php echo $discount_price; ?> </span></div>				 
				<?php } ?>
