      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <div id="product">
            ...
            <?php } ?>
			<div class="btn-group">
				<button class="wishlist" type="button" class="btn btn-default" title="<?php echo $button_wishlist; ?>" onclick="addWishlist('<?php echo $product_id; ?>');"></button>
				<button class="compare" type="button"  class="btn btn-default" title="<?php echo $button_compare; ?>" onclick="addCompare('<?php echo $product_id; ?>');"></button>
			</div>
            <div class="form-group">
