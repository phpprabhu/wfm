	...
	public function checkout() {
		...
		if ($this->cart->hasShipping()) {
			...
			$data_shipping = array(
				...
				//Prabhu
				'EMAIL'=>($this->session->data['paypal']['guest'] == true ? html_entity_decode($this->session->data['guest']['email']) : html_entity_decode($order_info['email'])),
				'PAYMENTREQUEST_0_SHIPTOPHONENUM'=>($this->session->data['paypal']['guest'] == true?$this->session->data['guest']['custom_field']['address'][1]:$order_info['telephone']),
