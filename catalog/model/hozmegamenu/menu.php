			...
			switch (substr($item, 0, strlen($value[1])))
			{
				...
				case 'LINK': 
					...
					if($link) {
						...
						$menu_html .= '<div id ="pt_menu_link'.$link['cmsblock_des_id'].'" class ="pt_menu pt_menu_link"><div class="parentMenu" ><span class="'.$span.'">'.$span.'</span><a href="'.($link['link']).'"><span>'.$link['title'].'</span></a></div></div>'.PHP_EOL;	
					}
				case 'CMS': 
                    ...
                    if(isset($cms['information_id'])) {
    					...
    					$menu_html .= '<div id ="pt_menu_cms" class ="pt_menu"><div class="parentMenu" ><a href="'.$cms_link.'"><span>'.$cms['title'].'</span></a></div></div>'.PHP_EOL;
                    }
			}
