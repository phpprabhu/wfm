	...
	public function index() {
      ...
      // >> Product Option Image PRO module
			...
			if ((float)$product_info['special']) {
				...
				$data['discount_price'] = $this->currency->format($this->tax->calculate(($product_info['price']-$product_info['special']), $product_info['tax_class_id'], $this->config->get('config_tax')), $this->session->data['currency']);
				$data['discount_percentage'] = round(($product_info['price']-$product_info['special'])/$product_info['price']*100, 2);
			} else {
				$data['special'] = false;
